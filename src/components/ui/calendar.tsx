    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    'bg-stone-900 text-stone-50 hover:bg-grey-900 hover:text-stone-50 focus:bg-stone-900 focus:text-stone-50 dark:bg-stone-50 dark:text-stone-900 dark:hover:bg-stone-50 dark:hover:text-stone-900 dark:focus:bg-stone-50 dark:focus:text-stone-900',
                day_today: 'dark:bg-stone-800 dark:text-white',
                day_outside:
